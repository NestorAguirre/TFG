...
package.domain = org.develop

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,kv,ttf,png,jpg,db

# (list) List of inclusions using pattern matching
source.include_patterns = assets/images/PriceListLogo.png
...
requirements = python3==3.8.10,kivy==2.1.0,sqlite3,pdfminer.six====20250324
...
presplash.filename = %(source.dir)s/assets/images/PriceListLogo.png

# (str) Icon of the application
icon = assets/images/PriceListLogo.png
