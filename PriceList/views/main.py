...
<MenuScreen>:
    BoxLayout:
        ...
        canvas.before:
            Color:
                rgba: 0.98, 0.95, 0.88, 1  # Fondo crema claro (#FAF3E0)
            Rectangle:
                pos: self.pos
                size: self.size
        ...
        Label:
            ...
            bold: True
            color: 0.2, 0.2, 0.2, 1  # Texto en gris oscuro
            size_hint_y: 0.12
            halign: 'center'
            valign: 'middle'
            ...
            canvas.before:
                Color:
                    rgba: 0.73, 0.37, 0.27, 1  # Línea terracota (#E07A5F)
                Rectangle:
        ...
        GridLayout:
            ...
            Button:
                ...
                on_release: app.cambiar_pantalla('frescos')
            ...
            Button:
                ...
                canvas.before:
                    Color:
                        rgba: self.background_color
                on_release: app.cambiar_pantalla('envasados')
            ...
            Button:
                ...
                canvas.before:
                    Color:
                        rgba: self.background_color
                on_release: app.cambiar_pantalla('congelados')
            ...
            Button:
                ...
                canvas.before:
                    Color:
                        rgba: self.background_color
                on_release: app.cambiar_pantalla('bebidas')
            ...
            Button:
                ...
                canvas.before:
                    Color:
                        rgba: self.background_color
                on_release: app.cambiar_pantalla('cuidadopersonal')
            ...
            Button:
                ...
                canvas.before:
                    Color:
                        rgba: self.background_color
                on_release: app.cambiar_pantalla('limpieza')
        ...
        Button:
            ...
            canvas.before:
                Color:
                    rgba: 0.35, 0.7, 0.5, 1  # Un poco más oscuro para el borde
