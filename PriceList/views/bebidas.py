                ...
                BoxLayout:
                    ...
                    RelativeLayout:
                        ...
                        Button:
                            ...
                            on_release:
                                app.familia('Bebidas no alcohólicas')
                                app.cambiar_pantalla('listadoproductos')
                        
                        Image:
                            source: 'assets/images/familias/Bebidas/NoAlcoholicas.png'
                            size_hint: 0.85, 0.85
                            pos_hint: {'center_x': 0.5, 'center_y': 0.5}
                ...
                BoxLayout:
                    ...
                    RelativeLayout:
                        ...
                        Button:
                            ...
                            on_release:
                                app.familia('Bebidas alcohólicas')
                                app.cambiar_pantalla('listadoproductos')
                        
                        Image:
                            source: 'assets/images/familias/Bebidas/Alcoholicas.png'
                            size_hint: 0.85, 0.85
                            pos_hint: {'center_x': 0.5, 'center_y': 0.5}
