                    ...
                    BoxLayout:
                        ...
                        RelativeLayout:
                            ...
                            Button:
                                ...
                                on_release:
                                    app.familia('Congelados de carne')
                                    app.cambiar_pantalla('listadoproductos')
                            
                            Image:
                                source: 'assets/images/familias/Congelados/Carne.png'
                                size_hint: 0.85, 0.85
                                pos_hint: {'center_x': 0.5, 'center_y': 0.5}
                    ...
                    BoxLayout:
                        ...
                        RelativeLayout:
                            ...
                            Button:
                                ...
                                on_release:
                                    app.familia('Congelado de pescado')
                                    app.cambiar_pantalla('listadoproductos')
                            
                            Image:
                                source: 'assets/images/familias/Congelados/PescadoMarisco.png'
                                size_hint: 0.85, 0.85
                                pos_hint: {'center_x': 0.5, 'center_y': 0.5}
                        
                        Label:
                            text: "Pescado y marisco"
                            font_size: app.label_font_size
                            bold: True
                            size_hint_y: 0.2
                            color: 0.2, 0.2, 0.2, 1
                    ...
                    BoxLayout:
                        ...
                        RelativeLayout:
                            ...
                            Button:
                                ...
                                on_release:
                                    app.familia('Congelados de verduras')
                                    app.cambiar_pantalla('listadoproductos')
                            
                            Image:
                                source: 'assets/images/familias/Congelados/Verduras.png'
                                size_hint: 0.85, 0.85
                                pos_hint: {'center_x': 0.5, 'center_y': 0.5}
                    ...
                    BoxLayout:
                        ...
                        RelativeLayout:
                            ...
                            Button:
                                ...
                                on_release:
                                    app.familia('Postres congelados')
                                    app.cambiar_pantalla('listadoproductos')
                            
                            Image:
                                source: 'assets/images/familias/Congelados/Postres.png'
                                size_hint: 0.85, 0.85
                                pos_hint: {'center_x': 0.5, 'center_y': 0.5}
                    ...
                    BoxLayout:
                        ...
                        RelativeLayout:
                            ...
                            Button:
                                ...
                                on_release:
                                    app.familia('Otros congelados')
                                    app.cambiar_pantalla('listadoproductos')
                            
                            Image:
                                source: 'assets/images/familias/Congelados/Otros.png'
                                size_hint: 0.85, 0.85
                                pos_hint: {'center_x': 0.5, 'center_y': 0.5}
