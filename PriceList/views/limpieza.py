                ...
                BoxLayout:
                    ...
                    RelativeLayout:
                        ...
                        Button:
                            ...
                            on_release:
                                app.familia('Limpieza del hogar')
                                app.cambiar_pantalla('listadoproductos')
                        
                        Image:
                            source: 'assets/images/familias/Limpieza/LimpiezaHogar.png'
                            size_hint: 0.85, 0.85
                            pos_hint: {'center_x': 0.5, 'center_y': 0.5}
                ...
                BoxLayout:
                    ...
                    RelativeLayout:
                        ...
                        Button:
                            ...
                            on_release:
                                app.familia('Productos de cocina')
                                app.cambiar_pantalla('listadoproductos')
                        
                        Image:
                            source: 'assets/images/familias/Limpieza/ProductosCocina.png'
                            size_hint: 0.85, 0.85
                            pos_hint: {'center_x': 0.5, 'center_y': 0.5}
                    
                    Label:
                        text: "Productos de cocina"
                        font_size: app.label_font_size
                        bold: True
                        size_hint_y: 0.2
                        color: 0.2, 0.2, 0.2, 1
