...
<DesayunoScreen>:
    ...
    BoxLayout:
        ...
        RelativeLayout:
            ...
            Label:
                text: "Desayuno"  # Corregido el título
                ...
                BoxLayout:
                    ...
                    BoxLayout:
                        ...
                        RelativeLayout:
                            ...
                            Button:
                                ...
                                on_release:
                                    app.familia('Bolleria')
                                    app.cambiar_pantalla('listadoproductos')
                            
                            Image:
                                source: 'assets/images/familias/Envasados/Bolleria.png'
                                size_hint: 0.85, 0.85
                                pos_hint: {'center_x': 0.5, 'center_y': 0.5}
                    ...
                    BoxLayout:
                        ...
                        RelativeLayout:
                            ...
                            Image:
                                source: 'assets/images/familias/Envasados/Pan.png'
                                size_hint: 0.85, 0.85
                                pos_hint: {'center_x': 0.5, 'center_y': 0.5}
                ...
                BoxLayout:
                    ...
                    BoxLayout:
                        ...
                        RelativeLayout:
                            ...
                            Button:
                                ...
                                on_release:
                                    app.familia('Cereales')
                                    app.cambiar_pantalla('listadoproductos')
                            
                            Image:
                                source: 'assets/images/familias/Envasados/Cereales.png'
                                size_hint: 0.85, 0.85
                                pos_hint: {'center_x': 0.5, 'center_y': 0.5}
                    ...
                    BoxLayout:
                        ...
                        RelativeLayout:
                            ...
                            Image:
                                source: 'assets/images/familias/Envasados/Otros.png'
                                size_hint: 0.85, 0.85
                                pos_hint: {'center_x': 0.5, 'center_y': 0.5}
